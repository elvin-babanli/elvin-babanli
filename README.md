# 💫 About Me:
Hi, I’m Elvin Babanli – a Computer Engineering student and a passionate problem solver who enjoys creating practical and creative solutions with code.<br><br>My programming journey started with curiosity and grew into a strong passion for system design, data analysis, and developing software that people can truly use.<br><br>🔹 Main focus:<br><br>Specializing in Python<br><br>Building valuable and efficient applications<br><br>Creating software integrated with Artificial Intelligence<br><br>Becoming highly skilled in PostgreSQL<br><br>💻 Technologies I’ve worked with:<br><br>Languages: Python, JavaScript, C#, SQL, PostgreSQL<br><br>Web Development: HTML, CSS, React, Node.js, MongoDB<br><br>Other Skills: Git/GitHub, REST APIs, Data Visualization, UML & System Design<br><br>🌍 Languages I speak:<br><br>Azerbaijani (native)<br><br>Turkish (fluent)<br><br>English (intermediate)<br><br>Russian (intermediate)<br><br>Polish (basic)
